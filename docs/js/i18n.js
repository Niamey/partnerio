...
const UI = {
  uk: {
    ...
    hero: {
      ...
      stat3: 'клієнтів',
      imgAlt: 'Штучний інтелект та високі технології — Partnerio',
      accentAlt: 'AI та нейромережі',
      visualBadge: 'AI · ML · High Tech',
    },
    showcase: {
      label: 'ШІ в дії',
  ...
  en: {
    ...
    hero: {
      ...
      stat2: 'ML/AI experts',
      stat3: 'clients',
      imgAlt: 'Artificial intelligence and high technology — Partnerio',
      accentAlt: 'AI and neural networks',
      visualBadge: 'AI · ML · High Tech',
    },
    showcase: {
      label: 'AI in action',
